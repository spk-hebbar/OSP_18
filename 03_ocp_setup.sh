...
export NEXTGEN_HYPERVISOR_BAREMETAL_INTERNAL_INTERFACE='eno4.118'
export NEXTGEN_OCP_CLUSTER_NAME="rhospnfv"
export NEXTGEN_OSP_BM_NODES=(rhos-nfv-02.lab.eng.rdu2.redhat.com)
...
export NEXTGEN_INTERNAL_CI_TOKEN='sha256~J8MAvIW3tVeAvhUgg5JPEUKQyN8ej0u42Kica1GoiYw'
