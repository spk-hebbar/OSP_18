...
export NEXTGEN_HYPERVISOR_BAREMETAL_INTERNAL_INTERFACE=eno1
export NEXTGEN_OCP_CLUSTER_NAME="rhospnfv"
export NEXTGEN_OSP_BM_NODES=(rhos-nfv-01.lab.eng.rdu2.redhat.com)
...
export NEXTGEN_INTERNAL_CI_TOKEN='sha256~PBy_be8wc6vhbYKAD8i5cCUmzys3sX8iKld1SyPuUfU'
